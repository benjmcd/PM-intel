...
def main() -> int:
    ...
    print(r"- python scripts\task.py setup-smoke (validates local setup diagnostics)")
    print(r"- python scripts\task.py scope-smoke (validates local-only/no-trading/no-SaaS boundaries)")
    print(r"- python scripts\task.py db-smoke (after python scripts\db_local.py verify)")
    print(r"- python scripts\task.py baseline-smoke (validates DB-free baseline/alert contracts)")
    print(r"- python scripts\task.py lifecycle-smoke (validates DB-free daemon lifecycle/restart contracts)")
