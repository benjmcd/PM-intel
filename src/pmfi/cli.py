...
def _register_subcommands(sub) -> None:  # noqa: ANN001
    ...
    p_soak_run_start.add_argument("--run-root", default=str(ROOT / "reports" / "soak-runs"), help="Run root directory")
    ...
    p_soak_run_status.add_argument("--run-root", default=str(ROOT / "reports" / "soak-runs"), help="Run root directory")
    ...
    p_soak_run_stop.add_argument("--run-root", default=str(ROOT / "reports" / "soak-runs"), help="Run root directory")
    ...
    p_soak_run_analyze.add_argument("--run-root", default=str(ROOT / "reports" / "soak-runs"), help="Run root directory")
